...
save_file_path = os.path.join(save_directory, "aruco_markers_and_brown_lines_detected.jpg")

# Define the file path for camera calibration data
calibration_file_path = os.path.join(current_directory, "calibration_data.npz")
