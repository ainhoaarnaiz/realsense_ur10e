...
def main():
    ...
    line_cloud, middle_point = cluster_point_cloud(cropped_cloud)


    # Create a red point at the closest point to the average y-value
    red_point = o3d.geometry.TriangleMesh.create_sphere(radius=0.002)
    ...
    o3d.visualization.draw_geometries([point_cloud, cropped_cloud, line_cloud, red_point], window_name="Point Cloud with Bounding Box and Clustering")
